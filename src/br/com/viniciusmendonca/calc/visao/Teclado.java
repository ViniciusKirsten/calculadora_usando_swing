...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		//linha 1
		c.gridwidth = 3;//ajustando a largura de todos os botoes para 3
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0);
		c.gridwidth = 1;;//ajustando a largura de todos os botoes para 1
		...
		//linha 5
		c.gridwidth = 2;//ajustando a largura de todos os botoes para 2
	...
	//Função para adicionar/criar o layout de cada botao
